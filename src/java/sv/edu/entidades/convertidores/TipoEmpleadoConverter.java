...
import sv.edu.entidades.controladores.TipoEmpleadoFacade;
...
@FacesConverter(value = "tipoEmpleadoConverter")
public class TipoEmpleadoConverter implements Converter {

    @Inject
    private TipoEmpleadoFacade ejbFacade;
