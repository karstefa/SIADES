...
import sv.edu.entidades.controladores.MoraFacade;
...
@FacesConverter(value = "moraConverter")
public class MoraConverter implements Converter {

    @Inject
    private MoraFacade ejbFacade;
